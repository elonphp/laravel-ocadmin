        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    @switch($table['status'])
                        @case('synced')
                            <span class="badge bg-success"><i class="bi bi-check"></i> {{ $lang->text_synced }}</span>
                            @break
                        @case('diff')
                            <span class="badge bg-warning text-dark"><i class="bi bi-exclamation-triangle"></i> {{ $lang->text_diff }} ({{ $table['change_count'] }})</span>
                            @break
                        @case('db_only')
