...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">{{ $option->exists ? $lang->text_edit : $lang->text_add }}</h3>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="bi bi-pencil"></i> {{ $option->exists ? $lang->text_edit : $lang->text_add }}
            </div>
            <div class="card-body">
                        ...
                        <table id="option-value" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr id="option-value-row-{{ $index }}">
                                    ...
                                    <td class="text-end">
                                        <button type="button" onclick="$('#option-value-row-{{ $index }}').remove();" data-bs-toggle="tooltip" title="{{ $lang->button_delete }}" class="btn btn-danger"><i class="bi bi-dash-circle"></i></button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td colspan="3"></td>
                                    <td class="text-end">
                                        <button type="button" onclick="addOptionValue();" data-bs-toggle="tooltip" title="{{ $lang->button_add }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i></button>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
...
function addOptionValue() {
    ...
    html += '<td class="text-end"><button type="button" onclick="$(\'#option-value-row-' + option_value_row + '\').remove();" data-bs-toggle="tooltip" title="{{ $lang->button_delete }}" class="btn btn-danger"><i class="bi bi-dash-circle"></i></button></td>';
    html += '</tr>';
