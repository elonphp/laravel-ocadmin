    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th>
                    <a href="{{ $sort_code }}" @class([$order => $sort === 'code'])>代碼</a>
                </th>
                <th>
                    <a href="{{ $sort_name }}" @class([$order => $sort === 'name'])>名稱</a>
                </th>
                <th>說明</th>
                <th class="text-center">詞彙數</th>
                <th class="text-center">
                    <a href="{{ $sort_sort_order }}" @class([$order => $sort === 'sort_order'])>排序</a>
                </th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">
                    <a href="{{ route('lang.ocadmin.config.taxonomy.edit', $taxonomy) }}" data-bs-toggle="tooltip" title="編輯" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
                </td>
            </tr>
            @empty
            <tr>
