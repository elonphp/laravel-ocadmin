...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">{{ $taxonomy->exists ? $lang->text_edit : $lang->text_add }}</h3>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="bi bi-pencil"></i> {{ $taxonomy->exists ? $lang->text_edit : $lang->text_add }}
            </div>
            <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ route('lang.ocadmin.config.term.index', ['filter_taxonomy_id' => $taxonomy->id]) }}" class="btn btn-outline-info btn-sm">
                                        <i class="bi bi-tags"></i> {{ $lang->text_view_terms ?? '查看詞彙項目' }}（{{ $taxonomy->terms()->count() }} 筆）
                                    </a>
                                    <a href="{{ route('lang.ocadmin.config.term.create', ['taxonomy_id' => $taxonomy->id]) }}" class="btn btn-outline-primary btn-sm">
                                        <i class="bi bi-plus-lg"></i> {{ $lang->text_add_term ?? '新增詞彙' }}
                                    </a>
                                </div>
                            </div>
                            @endif
