...
<div class="app-content">
    <div class="container-fluid">
        <div class="mb-3 text-end">
            ...
            <a href="{{ route('lang.ocadmin.organization.create') }}" data-bs-toggle="tooltip" title="{{ $lang->button_add }}" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    $('#button-delete').on('click', function() {
        ...
        if (confirm('{{ $lang->text_confirm_batch_delete }}'.replace('%s', selected.length))) {
            $.ajax({
                url: '{{ route('lang.ocadmin.organization.batch-delete') }}',
                type: 'POST',
