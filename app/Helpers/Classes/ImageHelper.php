 ...
 * 圖片縮圖快取
 *
 * 輸入相對 storage/app/public/ 的路徑，產生指定尺寸的縮圖快取，回傳完整 URL。
 * 不限定 root：picker 自己用的 'images/...'、system-managed 'products/...' /
 * 'banners/...' 都吃；cache 在頂層 'cache/' 鏡像對應原路徑。
 *
...
class ImageHelper
{
     ...
     * Resize
     *
     * @param string $filename 相對路徑，如 'images/categories/main.jpg' 或 'products/123/images/123_xK7p2qa.jpg'
     * @param int    $width
     * @param int    $height
