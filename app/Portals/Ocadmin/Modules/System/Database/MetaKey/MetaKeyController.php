...
class MetaKeyController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('ocadmin.system.database.metakey::index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        // 返回表格部分視圖
        return view('ocadmin.system.database.metakey::list', $data)->render();
    }
    ...
    public function create()
    {
        ...
        return view('ocadmin.system.database.metakey::form', [
            'metaKey' => new MetaKey(),
