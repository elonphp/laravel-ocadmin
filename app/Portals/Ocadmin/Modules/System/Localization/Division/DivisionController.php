...
namespace App\Portals\Ocadmin\Modules\System\Localization\Division;
...
class DivisionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => '行政區域新增成功！',
            'redirect_url' => route('lang.ocadmin.system.localization.division.edit', $division->id),
            'form_action' => route('lang.ocadmin.system.localization.division.update', $division->id),
        ]);
    }
