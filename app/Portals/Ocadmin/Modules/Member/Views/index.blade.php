    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="{{ route('lang.ocadmin.member.user.create') }}" data-bs-toggle="tooltip" title="新增" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    $('#button-filter').on('click', function() {
        var url = '{{ route('lang.ocadmin.member.user.list') }}?';
        var params = [];
    ...
    $('#button-delete').on('click', function() {
        ...
        if (confirm('確定要刪除選取的 ' + selected.length + ' 筆資料嗎？')) {
            $.ajax({
                url: '{{ route('lang.ocadmin.member.user.batch-delete') }}',
                type: 'POST',
                data: {
                    selected: selected,
                    _token: '{{ csrf_token() }}'
