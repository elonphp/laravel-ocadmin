...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="{{ route('lang.ocadmin.member.user.index') }}" data-bs-toggle="tooltip" title="返回" class="btn btn-light">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form id="form-account" action="{{ $user->exists ? route('lang.ocadmin.member.user.update', $user) : route('lang.ocadmin.member.user.store') }}" method="post" data-oc-toggle="ajax">
                    @csrf
                    @if($user->exists)
                    @method('PUT')
                    @endif
