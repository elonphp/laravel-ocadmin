...
namespace App\Portals\Ocadmin\Modules\Org\Department;
...
class DepartmentController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.org.departments.list');
        $data['index_url'] = route('lang.ocadmin.org.departments.index');
        $data['add_url'] = route('lang.ocadmin.org.departments.create');
        $data['batch_delete_url'] = route('lang.ocadmin.org.departments.batch-delete');

        return view('ocadmin::org.department.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $departments->withPath(route('lang.ocadmin.org.departments.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.org.departments.list');
        ...
        return view('ocadmin::org.department.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.departments.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.departments.index', $request);

        return view('ocadmin::org.department.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.org.departments.edit', $department),
            'form_action' => route('lang.ocadmin.org.departments.update', $department),
        ]);
    }
    ...
    public function edit(Request $request, Department $department): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.departments.update', $department);
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.departments.index', $request);
