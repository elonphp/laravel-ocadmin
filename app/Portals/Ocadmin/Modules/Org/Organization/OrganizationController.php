...
namespace App\Portals\Ocadmin\Modules\Org\Organization;
...
class OrganizationController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.org.organizations.list');
        $data['index_url'] = route('lang.ocadmin.org.organizations.index');
        $data['add_url'] = route('lang.ocadmin.org.organizations.create');
        $data['batch_delete_url'] = route('lang.ocadmin.org.organizations.batch-delete');

        return view('ocadmin::org.organization.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $organizations->withPath(route('lang.ocadmin.org.organizations.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.org.organizations.list');
        ...
        return view('ocadmin::org.organization.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.organizations.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.organizations.index', $request);

        return view('ocadmin::org.organization.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.org.organizations.edit', $organization),
            'form_action' => route('lang.ocadmin.org.organizations.update', $organization),
        ]);
    }
    ...
    public function edit(Request $request, Organization $organization): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.organizations.update', $organization);
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.organizations.index', $request);
