...
namespace App\Portals\Ocadmin\Modules\Org\Company;
...
class CompanyController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.org.companies.list');
        $data['index_url'] = route('lang.ocadmin.org.companies.index');
        $data['add_url'] = route('lang.ocadmin.org.companies.create');
        $data['batch_delete_url'] = route('lang.ocadmin.org.companies.batch-delete');

        return view('ocadmin::org.company.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $companies->withPath(route('lang.ocadmin.org.companies.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.org.companies.list');
        ...
        return view('ocadmin::org.company.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.companies.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.companies.index', $request);

        return view('ocadmin::org.company.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.org.companies.edit', $company),
            'form_action' => route('lang.ocadmin.org.companies.update', $company),
        ]);
    }
    ...
    public function edit(Request $request, Company $company): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.companies.update', $company);
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.companies.index', $request);
