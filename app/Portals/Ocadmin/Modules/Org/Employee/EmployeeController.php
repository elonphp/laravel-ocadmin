...
namespace App\Portals\Ocadmin\Modules\Org\Employee;
...
class EmployeeController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.org.employees.list');
        $data['index_url'] = route('lang.ocadmin.org.employees.index');
        $data['add_url'] = route('lang.ocadmin.org.employees.create');
        $data['batch_delete_url'] = route('lang.ocadmin.org.employees.batch-delete');

        return view('ocadmin::org.employee.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $employees->withPath(route('lang.ocadmin.org.employees.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.org.employees.list');
        ...
        return view('ocadmin::org.employee.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.employees.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.employees.index', $request);
        $data['search_users_url'] = route('lang.ocadmin.org.employees.search-users');

        return view('ocadmin::org.employee.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            'employee_no'     => 'nullable|string|max:20|unique:org_employees',
            'first_name'      => 'required|string|max:50',
            'last_name'       => 'nullable|string|max:50',
            'email'           => 'nullable|email|max:100',
            'phone'           => 'nullable|string|max:30',
            'user_id'         => 'nullable|exists:users,id',
            'company_id'      => 'nullable|exists:org_companies,id',
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.org.employees.edit', $employee),
            'form_action' => route('lang.ocadmin.org.employees.update', $employee),
        ]);
    }
    ...
    public function edit(Request $request, Employee $employee): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.org.employees.update', $employee);
        $data['back_url'] = $this->backUrl('lang.ocadmin.org.employees.index', $request);
        $data['search_users_url'] = route('lang.ocadmin.org.employees.search-users');
    ...
    {
        $validated = $request->validate([
            'employee_no'     => 'nullable|string|max:20|unique:org_employees,employee_no,' . $employee->id,
            'first_name'      => 'required|string|max:50',
            'last_name'       => 'nullable|string|max:50',
            'email'           => 'nullable|email|max:100',
            'phone'           => 'nullable|string|max:30',
