...
namespace App\Portals\Ocadmin\Modules\Common\Term;
...
class TermController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('ocadmin.common.term::index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        return view('ocadmin.common.term::list', $data)->render();
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('ocadmin.common.term::form', [
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => '詞彙新增成功！',
            'redirect_url' => route('lang.ocadmin.system.taxonomy.term.edit', $term->id),
            'form_action' => route('lang.ocadmin.system.taxonomy.term.update', $term->id),
        ]);
    }
