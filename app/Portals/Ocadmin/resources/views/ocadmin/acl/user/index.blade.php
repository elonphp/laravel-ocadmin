    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="{{ route('lang.ocadmin.system.users.create') }}" data-bs-toggle="tooltip" title="{{ $lang->button_add }}" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    $('#button-delete').on('click', function() {
        ...
        if (confirm('{{ $lang->text_confirm_batch_delete }}'.replace('%s', selected.length))) {
            $.ajax({
                url: '{{ route('lang.ocadmin.system.users.batch-delete') }}',
                type: 'POST',
