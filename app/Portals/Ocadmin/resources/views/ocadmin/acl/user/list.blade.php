...
{{ $user->roles->pluck('display_name')->join(', ') ?: '-' }}
                ...
                <td class="text-end">
                    <a href="{{ route('lang.ocadmin.system.users.edit', $user) . $urlParams }}" data-bs-toggle="tooltip" title="{{ $lang->button_edit }}" class="btn btn-primary"><i class="fa-solid fa-pencil"></i></a>
                </td>
            </tr>
            @empty
            <tr>
