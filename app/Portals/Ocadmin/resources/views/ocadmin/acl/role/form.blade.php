    ...
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">
                <i class="fa-solid fa-pencil"></i> {{ $role->exists ? $lang->text_edit : $lang->text_add }}
            </div>
            <div class="card-body">
                ...
                <form action="{{ $save_url }}" method="post" id="form-role" data-oc-toggle="ajax">
                    @csrf
                    @if($role->exists)
                    @method('PUT')
                    @endif
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-switch mt-2">
                                        ...
                                        <input type="checkbox" name="is_active" value="1" id="input-is_active" class="form-check-input" @checked(old('is_active', $role->is_active ?? true))>
                                    </div>
                                </div>
                            </div>
                        </div>
