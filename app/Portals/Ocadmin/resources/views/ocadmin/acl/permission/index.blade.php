    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="{{ route('lang.ocadmin.system.permissions.create') }}" data-bs-toggle="tooltip" title="{{ $lang->button_add }}" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    $('#button-filter').on('click', function() {
        var url = '{{ route('lang.ocadmin.system.permissions.list') }}?';
        var params = [];
    ...
    $('#button-clear').on('click', function() {
        ...
        var url = '{{ route('lang.ocadmin.system.permissions.list') }}';
        window.history.pushState({}, null, '{{ route('lang.ocadmin.system.permissions.index') }}');
        $('#permission-list').load(url);
    });
    ...
    $('#button-delete').on('click', function() {
        ...
        if (confirm('{{ $lang->text_confirm_batch_delete }}'.replace('%s', selected.length))) {
            $.ajax({
                url: '{{ route('lang.ocadmin.system.permissions.batch-delete') }}',
                type: 'POST',
