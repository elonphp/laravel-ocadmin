...
<div id="content">
    ...
    <div class="container-fluid">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form action="{{ $save_url }}" method="post" id="form-department" data-oc-toggle="ajax">
                    @csrf
                    ...
                    <div class="row mb-3 required">
                        ...
                        <div class="col-sm-10">
                            <select name="company_id" id="input-company_id" class="form-select">
                                ...
                                <option value="{{ $company->id }}" @selected(old('company_id', $department->company_id) == $company->id)>{{ $company->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="parent_id" id="input-parent_id" class="form-select">
                                ...
                                <option value="{{ $option->id }}" data-company-id="{{ $option->company_id }}" @selected(old('parent_id', $department->parent_id) == $option->id)>{{ $option->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-switch mt-2">
                                ...
                                <input type="checkbox" name="is_active" value="1" id="input-is_active" class="form-check-input" @checked(old('is_active', $department->is_active ?? true))>
                            </div>
                        </div>
                    </div>
