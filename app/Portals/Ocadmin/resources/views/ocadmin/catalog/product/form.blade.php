    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="{{ $back_url }}" data-bs-toggle="tooltip" title="{{ $lang->button_back }}" class="btn btn-light">
                    <i class="fa-solid fa-reply"></i>
                </a>
            </div>
            <h1>{{ $product->exists ? $lang->text_edit : $lang->text_add }}</h1>
        </div>
    </div>
                            ...
                            <div id="product-option-container">
                                ...
                                <fieldset id="option-row-{{ $row }}">
                                    <legend>
                                        ...
                                        <button type="button" onclick="$('#option-row-{{ $row }}').remove();" class="btn btn-danger btn-sm float-end"><i class="fa-solid fa-minus-circle"></i></button>
                                    </legend>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody id="option-value-tbody-{{ $row }}">
                                            ...
                                            <tr id="option-value-row-{{ $row }}-{{ $valRow }}">
                                                ...
                                                <td class="text-end">
                                                    <button type="button" data-option-row="{{ $row }}" data-option-value-row="{{ $valRow }}" class="btn btn-primary btn-sm btn-edit-option-value"><i class="fa-solid fa-pencil"></i></button>
                                                    <button type="button" onclick="$('#option-value-row-{{ $row }}-{{ $valRow }}').remove();" class="btn btn-danger btn-sm"><i class="fa-solid fa-minus-circle"></i></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-end">
                                                    <button type="button" onclick="openModalAdd({{ $row }});" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus-circle"></i></button>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <button type="button" id="button-option-add" class="btn btn-primary"><i class="fa-solid fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ $lang->button_cancel }}</button>
...
$('#button-option-add').on('click', function() {
    ...
    html += ' <button type="button" onclick="$(\'#option-row-' + option_row + '\').remove();" class="btn btn-danger btn-sm float-end"><i class="fa-solid fa-minus-circle"></i></button>';
    html += '</legend>';
    ...
    if (isChoice) {
        ...
        html += '<td class="text-end"><button type="button" onclick="openModalAdd(' + option_row + ');" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus-circle"></i></button></td>';
        html += '</tr></tfoot></table>';
    } else {
        html += '<div class="row mb-3">';
...
$('#modal-save').on('click', function() {
    ...
    html += '<button type="button" data-option-row="' + optRow + '" data-option-value-row="' + valRow + '" class="btn btn-primary btn-sm btn-edit-option-value"><i class="fa-solid fa-pencil"></i></button> ';
    html += '<button type="button" onclick="$(\'#option-value-row-' + optRow + '-' + valRow + '\').remove();" class="btn btn-danger btn-sm"><i class="fa-solid fa-minus-circle"></i></button>';
    html += '</td>';
    html += '</tr>';
