    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr @if(!$product->status) style="opacity: 0.5;" @endif>
                ...
                <td class="text-end">
                    <a href="{{ route('lang.ocadmin.catalog.products.edit', $product) . $urlParams }}" data-bs-toggle="tooltip" title="{{ $lang->button_edit }}" class="btn btn-primary"><i class="fa-solid fa-pencil"></i></a>
                </td>
            </tr>
            @empty
            <tr>
