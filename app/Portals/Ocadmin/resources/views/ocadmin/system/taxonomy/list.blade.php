    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('lang.ocadmin.system.terms.index', ['filter_taxonomy_id' => $taxonomy->id]) }}" class="badge bg-info text-decoration-none">
                ...
                <td class="text-end">
                    <a href="{{ route('lang.ocadmin.system.taxonomies.edit', $taxonomy) . $urlParams }}" data-bs-toggle="tooltip" title="編輯" class="btn btn-primary"><i class="fa-solid fa-pencil"></i></a>
                </td>
            </tr>
            @empty
            <tr>
