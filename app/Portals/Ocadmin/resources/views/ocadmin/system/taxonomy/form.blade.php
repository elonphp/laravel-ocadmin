                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-basic" class="tab-pane">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ route('lang.ocadmin.system.terms.index', ['filter_taxonomy_id' => $taxonomy->id]) }}" class="btn btn-outline-info btn-sm">
                                        <i class="fa-solid fa-tags"></i> {{ $lang->text_view_terms ?? '查看詞彙項目' }}（{{ $taxonomy->terms()->count() }} 筆）
                                    </a>
                                    <a href="{{ route('lang.ocadmin.system.terms.create', ['taxonomy_id' => $taxonomy->id]) }}" class="btn btn-outline-primary btn-sm">
