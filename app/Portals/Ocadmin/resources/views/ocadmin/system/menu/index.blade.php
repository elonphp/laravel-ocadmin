...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            {{-- 篩選區塊 --}}
            <div id="filter-menu" class="col-lg-3 col-md-12 order-lg-last d-none d-lg-block mb-3">
                <div class="card">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="card">
                    ...
                    <div id="menu-list" class="card-body">
                        {!! $list !!}
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#menu-list').on('click', 'thead a, .pagination a', function(e) {
        e.preventDefault();
