...
class TermController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.system.terms.list');
        $data['index_url'] = route('lang.ocadmin.system.terms.index');
        $data['add_url'] = route('lang.ocadmin.system.terms.create');
        $data['batch_delete_url'] = route('lang.ocadmin.system.terms.batch-delete');

        return view('ocadmin::system.term.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $terms->withPath(route('lang.ocadmin.system.terms.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.system.terms.list');
        ...
        return view('ocadmin::system.term.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.terms.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.terms.index', $request);
        $data['by_taxonomy_url'] = route('lang.ocadmin.system.terms.by-taxonomy', ':id');

        return view('ocadmin::system.term.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.system.terms.edit', $term),
            'form_action' => route('lang.ocadmin.system.terms.update', $term),
        ]);
    }
    ...
    public function edit(Request $request, Term $term): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.terms.update', $term);
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.terms.index', $request);
        $data['by_taxonomy_url'] = route('lang.ocadmin.system.terms.by-taxonomy', ':id');
