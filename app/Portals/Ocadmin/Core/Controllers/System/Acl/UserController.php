...
class UserController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.system.acl.users.list');
        $data['index_url'] = route('lang.ocadmin.system.acl.users.index');
        $data['add_url'] = route('lang.ocadmin.system.acl.users.create');
        $data['batch_delete_url'] = route('lang.ocadmin.system.acl.users.batch-delete');

        return view('ocadmin::system.acl.user.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $users->withPath(route('lang.ocadmin.system.acl.users.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.system.acl.users.list');
        ...
        return view('ocadmin::system.acl.user.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.acl.users.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.acl.users.index', $request);

        return view('ocadmin::system.acl.user.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.system.acl.users.edit', $user),
            'form_action' => route('lang.ocadmin.system.acl.users.update', $user),
        ]);
    }
    ...
    public function edit(Request $request, User $user): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.acl.users.update', $user);
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.acl.users.index', $request);
