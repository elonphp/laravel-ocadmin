...
class RoleController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.system.acl.roles.list');
        $data['index_url'] = route('lang.ocadmin.system.acl.roles.index');
        $data['add_url'] = route('lang.ocadmin.system.acl.roles.create');
        $data['batch_delete_url'] = route('lang.ocadmin.system.acl.roles.batch-delete');

        return view('ocadmin::system.acl.role.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $baseUrl = route('lang.ocadmin.system.acl.roles.list');
        ...
        return view('ocadmin::system.acl.role.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.acl.roles.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.acl.roles.index', $request);

        return view('ocadmin::system.acl.role.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.system.acl.roles.edit', $role),
            'form_action' => route('lang.ocadmin.system.acl.roles.update', $role),
        ]);
    }
    ...
    public function edit(Request $request, Role $role): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.acl.roles.update', $role);
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.acl.roles.index', $request);
