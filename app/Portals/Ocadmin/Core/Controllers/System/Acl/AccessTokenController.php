...
class AccessTokenController extends OcadminController
{
    ...
    {
        return ['system/acl/access_token'];
    }
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.system.acl.access-tokens.list');
        $data['index_url'] = route('lang.ocadmin.system.acl.access-tokens.index');
        $data['add_url'] = route('lang.ocadmin.system.acl.access-tokens.form');
        $data['revoke_url'] = route('lang.ocadmin.system.acl.access-tokens.revoke');

        return view('ocadmin::system.acl.access-token.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        foreach ($tokens as $row) {
            ...
            $row->edit_url = route('lang.ocadmin.system.acl.access-tokens.form', [$row->id]);
        }
        ...
        $data['pagination'] = $tokens->withPath(route('lang.ocadmin.system.acl.access-tokens.list'))->appends($query_data)->links('ocadmin::pagination.default');
        ...
        $base_url = route('lang.ocadmin.system.acl.access-tokens.list');
        ...
        return view('ocadmin::system.acl.access-token.list', $data)->render();
    }
    ...
    public function form(Request $request, $id = null): View
    {
        ...
        $data['save_url'] = $id
            ? route('lang.ocadmin.system.acl.access-tokens.save', $id)
            : route('lang.ocadmin.system.acl.access-tokens.save');
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.acl.access-tokens.index', $request);
        $data['search_users_url'] = route('lang.ocadmin.system.acl.access-tokens.search-users');

        return view('ocadmin::system.acl.access-token.form', $data);
    }
    ...
    public function save(Request $request, $id = null): JsonResponse
    {
        ...
        if ($id) {
            ...
            return response()->json([
                ...
                'redirect' => route('lang.ocadmin.system.acl.access-tokens.index'),
            ]);
        }
