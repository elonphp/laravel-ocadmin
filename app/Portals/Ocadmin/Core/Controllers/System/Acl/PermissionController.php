...
class PermissionController extends OcadminController
{
    ...
    protected function getList(Request $request): string
    {
        ...
        $permissions->withPath(route('lang.ocadmin.system.acl.permissions.list'))->withQueryString();
    ...
    public function create(Request $request): View
    {
        ...
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.acl.permissions.index', $request);
