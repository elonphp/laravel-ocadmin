...
class UserDeviceController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.system.acl.user-devices.list');
        $data['index_url'] = route('lang.ocadmin.system.acl.user-devices.index');
        $data['force_revoke_url'] = route('lang.ocadmin.system.acl.user-devices.force-revoke');

        return view('ocadmin::system.acl.user-device.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $data['pagination'] = $devices->withPath(route('lang.ocadmin.system.acl.user-devices.list'))->appends($query_data)->links('ocadmin::pagination.default');
        ...
        $base_url = route('lang.ocadmin.system.acl.user-devices.list');
        ...
        return view('ocadmin::system.acl.user-device.list', $data)->render();
    }
