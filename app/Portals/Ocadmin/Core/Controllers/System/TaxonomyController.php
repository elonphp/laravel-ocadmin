...
class TaxonomyController extends OcadminController
{
    ...
    public function index(Request $request): View
    {
        ...
        $data['list_url'] = route('lang.ocadmin.system.taxonomies.list');
        $data['index_url'] = route('lang.ocadmin.system.taxonomies.index');
        $data['add_url'] = route('lang.ocadmin.system.taxonomies.create');
        $data['batch_delete_url'] = route('lang.ocadmin.system.taxonomies.batch-delete');

        return view('ocadmin::system.taxonomy.index', $data);
    }
    ...
    protected function getList(Request $request): string
    {
        ...
        $taxonomies->withPath(route('lang.ocadmin.system.taxonomies.list'))->withQueryString();
        ...
        $baseUrl = route('lang.ocadmin.system.taxonomies.list');
        ...
        return view('ocadmin::system.taxonomy.list', $data)->render();
    }
    ...
    public function create(Request $request): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.taxonomies.store');
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.taxonomies.index', $request);

        return view('ocadmin::system.taxonomy.form', $data);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'replace_url' => route('lang.ocadmin.system.taxonomies.edit', $taxonomy),
            'form_action' => route('lang.ocadmin.system.taxonomies.update', $taxonomy),
        ]);
    }

    public function edit(Request $request, Taxonomy $taxonomy): View
    {
        ...
        $data['save_url'] = route('lang.ocadmin.system.taxonomies.update', $taxonomy);
        $data['back_url'] = $this->backUrl('lang.ocadmin.system.taxonomies.index', $request);
