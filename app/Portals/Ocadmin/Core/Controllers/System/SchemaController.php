...
use App\Portals\Ocadmin\Core\Services\SchemaService;
...
class SchemaController extends OcadminController
{
     ...
     * 編輯單表：扁平表格，原名明示
     */
    public function edit(Request $request, string $table): View
    {
        ...
        $data['back_url']    = $this->backUrl('lang.ocadmin.system.schemas.index', $request);
