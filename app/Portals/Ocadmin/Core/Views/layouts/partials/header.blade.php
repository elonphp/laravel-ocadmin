    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li id="nav-profile" class="nav-item dropdown">
                <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle">
                    <img src="{{ asset('assets/ocadmin/image/profile.png') }}" alt="{{ auth()->user()->display_name ?? auth()->user()->name ?? 'Admin' }}" title="{{ auth()->user()->display_name ?? auth()->user()->name ?? 'Admin' }}" class="rounded-circle">
