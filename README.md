...
- **Documents**: https://elonphp.github.io/ocadmin/en/
- **繁體中文說明**：https://elonphp.github.io/ocadmin/

> The site above is a **quick, narrative-style tour** of what Ocadmin is and why you'd use it. For the **in-repo technical reference** (coding conventions, schema sync, migration numbering, view conventions, etc.), see [`docs/common/`](./docs/common/) in this repository.
>
> 上面的部落格是**快速、通俗的介紹**：講 Ocadmin 是什麼、為什麼這樣設計。repo 內 [`docs/common/`](./docs/common/) 是**技術性參考文件**（程式規範、Schema 同步、Migration 編號、視圖規範…等實作層面）。
...
> **First login**
> Seeders create demo accounts with password `123456` (e.g. `admin@example.com`).
...
> **首次登入**
> Seeder 會建立預設帳號，密碼一律 `123456`（如 `admin@example.com`）。
