    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th>
                    <a href="{{ route('ocadmin.setting.index', array_merge(request()->all(), ['sort' => 'code', 'order' => request('order') === 'asc' && request('sort') === 'code' ? 'desc' : 'asc'])) }}" @class([request('order', 'asc') => request('sort') === 'code'])>
                        代碼
                    </a>
                </th>
                <th>
                    <a href="{{ route('ocadmin.setting.index', array_merge(request()->all(), ['sort' => 'group', 'order' => request('order') === 'asc' && request('sort') === 'group' ? 'desc' : 'asc'])) }}" @class([request('order', 'asc') => request('sort') === 'group'])>
                        群組
                    </a>
                </th>
                <th>內容</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">
                    <a href="{{ route('ocadmin.setting.edit', $setting) }}" data-bs-toggle="tooltip" title="編輯" class="btn btn-primary"><i class="fa-solid fa-pencil"></i></a>
                </td>
            </tr>
            @empty
            <tr>
