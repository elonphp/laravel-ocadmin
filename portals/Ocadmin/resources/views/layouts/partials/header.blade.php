    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li id="nav-profile" class="nav-item dropdown">
                <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle">
                    <img src="{{ asset('assets-ocadmin/vendor/opencart/image/profile.png') }}" alt="{{ auth()->user()->display_name ?? auth()->user()->name ?? 'Admin' }}" title="{{ auth()->user()->display_name ?? auth()->user()->name ?? 'Admin' }}" class="rounded-circle">
                    <span class="d-none d-md-inline d-lg-inline">&nbsp;&nbsp;&nbsp;{{ auth()->user()->display_name ?? auth()->user()->name ?? 'Admin' }} <i class="fa-solid fa-caret-down fa-fw"></i></span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a href="#" class="dropdown-item"><i class="fa-solid fa-user-circle fa-fw"></i> 個人資料</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><h6 class="dropdown-header">商店</h6></li>
                    <li><a href="/" target="_blank" class="dropdown-item">前台首頁</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><h6 class="dropdown-header">說明</h6></li>
                    <li><a href="https://www.opencart.com" target="_blank" class="dropdown-item"><i class="fa-brands fa-opencart fa-fw"></i> OpenCart</a></li>
                    <li><a href="https://docs.opencart.com" target="_blank" class="dropdown-item"><i class="fa-solid fa-file fa-fw"></i> 文件</a></li>
                </ul>
            </li>
