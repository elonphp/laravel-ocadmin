...
>
> 開發人員於版本升級的統一部署流程，請使用 [00007_資料庫Transition變更機制](00007_資料庫Transition變更機制.md)。
...
使用此功能即代表接受：**後續結構維護一律走本 UI 或 [00007 Transition](00007_資料庫Transition變更機制.md)**，migration 系統視為凍結狀態。
