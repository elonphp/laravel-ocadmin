...
以下為鼎新 Cosmos ERP 的系統別代碼，對照本規範的 MM 模組區段。
本專案不會實作全部系統，僅作為規劃 MM 區段時的容量驗證參考。

| Cosmos | 系統名稱 | MM | 本規範模組 |
|--------|---------|-----|-----------|
| **基礎設施 01–09** | | | |
| ADM | 管理維護系統 | 04 | 系統工具 System |
| CMS | 基本資料管理系統 | 02 | 共用資料 Common |
| LAN | 自定語系管理系統 | 02 | 共用資料 Common |
| OLA | 線上API接口系統 | 05 | API 接口 Integration |
| PIP | 個人資料保護管理系統 | 06 | 個資保護 Privacy |
| PSM | 序號管理系統 | 07 | 序號管理 Sequence |
| FEP | Fax/Email處理系統 | 08 | 通知訊息 Messaging |
| IMS | 智能流程管理系統 | 09 | 工作流程 Workflow |
| **人資行政 10–19** | | | |
| PAL | 人事薪資管理系統 | 10–13 | 組織架構＋出勤＋薪資＋保險 |
| AMS | 刷卡管理系統 | 11 | 出勤管理 Attendance |
| PCM | 零用金管理系統 | 15 | 零用金 Petty Cash |
| PCS | 專案管理系統 | 16 | 專案管理 Project |
| AST | 固定資產管理系統 | 17 | 固定資產 Asset |
| **電商零售 20–29** | | | |
| OLS | 網路購物管理系統 | 20–26 | 商品＋訂單＋金流＋物流 |
| OLC | 網路金流管理系統 | 25 | 金流 Payment |
| POS | POS總部管理系統 | 27 | POS / 連鎖加盟 |
| CFM | 總部連鎖加盟管理系統 | 27 | POS / 連鎖加盟 |
| NRC | 新零售管理系統 | 28 | 新零售 New Retail |
| NR3 | 新零售管理系統V3 | 28 | 新零售 New Retail |
| WCA | 服飾管理系統 | 29 | 保留（行業專用） |
| **進銷存 30–39** | | | |
| COP | 訂單管理系統 | 33 | 銷售 Sales |
| PUR | 採購管理系統 | 31 | 採購 Procurement |
| INV | 庫存管理系統 | 32 | 庫存 Inventory |
| COM | 合約管理系統 | 34 | 合約 Contract |
| LDM | 物流配送管理系統 | 35 | 物流配送 Distribution |
| ALS | 廠內智能物流(智互聯) | 35 | 物流配送 Distribution |
| MTP | 多角貿易管理系統 | 36 | 貿易管理 Trade |
| EPS | 出口作業管理系統 | 37 | 進出口 Import/Export |
| IPS | 進口作業管理系統 | 37 | 進出口 Import/Export |
| PXM | 軍福品管理系統 | 38 | 行業專用 |
| **製造品管 40–49** | | | |
| BOM | 產品結構管理系統 | 40 | 產品結構 BOM |
| SFC | 製程管理系統 | 41 | 製程管理 SFC |
| MOC | 製令/託外管理系統 | 42 | 製令 / 託外 Work Order |
| QMS | 品質管理系統 | 43 | 品質管理 QMS |
| RMA | 維修服務系統 | 44 | 維修服務 RMA |
| MRP | 物料需求計劃系統 | 45 | 物料需求 MRP |
| LRP | 批次需求計劃系統 | 45 | 物料需求 MRP |
| CST | 成本計算管理系統 | 46 | 成本計算 Costing |
| **財務稅務 50–59** | | | |
| ACT | 會計總帳管理系統 | 50 | 會計總帳 GL |
| ACP | 應付管理系統 | 51 | 應付帳款 AP |
| ACR | 應收管理系統 | 52 | 應收帳款 AR |
| AJS | 自動分錄系統 | 53 | 自動分錄 AJS |
| NOT | 票據資金管理系統 | 54 | 票據資金 Notes |
| TAX | 營業稅申報系統 | 55 | 稅務申報 Tax |
| EIN | 電子發票管理系統 | 56 | 電子發票 E-Invoice |
| EIV | 電子發票交換平台系統 | 56 | 電子發票 E-Invoice |
| BAC | 商業會計接軌系統 | 57 | 商業會計 Accounting Standards |
| FCS | 合併財報管理系統 | 58 | 合併財報 Consolidated |
| **報表監控 80–89** | | | |
| RGR | 自訂報表系統 | 80 | 自訂報表 Report |
| TBB | 營運監控平台 | 81 | 營運監控 Dashboard |
| MTI | 監控檢核管理系統 | 81 | 營運監控 Dashboard |
| **其他 90–99** | | | |
| MOB | 行動化管理系統 | 90 | 行動化 Mobile |
| IMG | 企業行動導航 | 90 | 行動化 Mobile |
| EBO | e-B Online 連結系統 | 91 | 線上整合 Online |
| IWC | 行業攻略雲管理系統 | 92 | 保留 |
