...
```json
{
    "success": true,
    "message": "新增成功",
    "replace_url": "/zh-hant/admin/system/permissions/1/edit",
    "form_action": "/zh-hant/admin/system/permissions/1"
}
```
...
| `00003_Ocadmin程式規範.md` | 更新表單 AJAX 提交規範章節，改用新格式範例 |
| `10013_例外處理.md` | 更新 JSON 回應格式章節 |
...
- [00004_Ocadmin-common.js說明.md](00004_Ocadmin-common.js說明.md)
- [10013_例外處理.md](10013_例外處理.md)
