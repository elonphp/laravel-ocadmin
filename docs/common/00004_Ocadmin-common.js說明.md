...
> 詳見 [10014_JSON回應格式.md](10014_JSON回應格式.md)。
...
> 全域 handler 的轉換邏輯位於 `bootstrap/app.php` 的 ValidationException 處理區段。詳見 [10013_例外處理.md](10013_例外處理.md)。
...
- [00003_Ocadmin程式規範.md](00003_Ocadmin程式規範.md) — 表單 AJAX 規範、ID 命名規範
- [10013_例外處理.md](10013_例外處理.md) — 全域例外 handler
