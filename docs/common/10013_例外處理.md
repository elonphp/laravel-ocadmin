...
簡單 CRUD 不需要 Service 和 CustomException（參照 [00003_Ocadmin程式規範.md](00003_Ocadmin程式規範.md) 的「何時使用 Service」）：
...
所有回應皆遵循統一格式，詳見 [10014_JSON回應格式.md](10014_JSON回應格式.md)。
...
- [10000_系統架構.md](10000_系統架構.md)
- [00003_Ocadmin程式規範.md](00003_Ocadmin程式規範.md)
- [10014_JSON回應格式.md](10014_JSON回應格式.md)
...
**決議：** 統一為 `{ success: boolean, message: string, errors?: object }`，不使用 `error` / `error_warning`。前端改為 `handleJsonResponse()`。詳見 [10014_JSON回應格式.md](10014_JSON回應格式.md)。
...
**問題：** `00003_Ocadmin程式規範.md` 的表單 AJAX 範例仍使用舊格式（`error_warning`、手動 `validator()`）。
