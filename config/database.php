    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            // 連線時區固定 +08:00（⚠️ 勿刪·見 docs/common/10028 §四）：以台北時間儲存（app.timezone=Asia/Taipei），
            // 此固定讓 timestamp 欄在「本地台北 / 遠端 UTC」不同伺服器上解讀一致；若刪掉此行，則遠端的 created_at/updated_at 會錯 8 小時。
            'timezone' => '+08:00',
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
        ...
        'sysdata' => [
            ...
            // 連線時區固定 +08:00（⚠️ 勿刪·見 docs/common/10028 §四）：sysdata 跨專案共用，全體須採同一基準（台北）。
            'timezone' => '+08:00',
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
