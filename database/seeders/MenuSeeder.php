...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->createMenu($portal, $catalog->id, [
            'permission_name' => permName('catalog.product.menu'),
        ...
        $this->createMenu($portal, $catalog->id, [
            'permission_name' => permName('catalog.option.menu'),
        ...
        $this->createMenu($portal, $catalog->id, [
            'permission_name' => permName('catalog.option_value_group.menu'),
        ...
        $this->createMenu($portal, $catalog->id, [
            'permission_name' => permName('catalog.option_value_link.menu'),
        ...
        $this->createMenu($portal, $member->id, [
            'permission_name' => permName('member.member.menu'),
        ...
        $this->createMenu($portal, $org->id, [
            'permission_name' => permName('org.organization.menu'),
        ...
        $this->createMenu($portal, $org->id, [
            'permission_name' => permName('org.company.menu'),
        ...
        $this->createMenu($portal, $org->id, [
            'permission_name' => permName('org.department.menu'),
        ...
        $this->createMenu($portal, $org->id, [
            'permission_name' => permName('org.employee.menu'),
        ...
        $this->createMenu($portal, $acl->id, [
            'permission_name' => permName('system_acl.permission.menu'),
            'route_name' => 'lang.ocadmin.system.acl.permissions.index',
            'sort_order' => 1,
        ], [
            'en' => 'Permissions',
            'zh_Hant' => '權限管理',
        ...
        $this->createMenu($portal, $acl->id, [
            'permission_name' => permName('system_acl.role.menu'),
            'route_name' => 'lang.ocadmin.system.acl.roles.index',
            'sort_order' => 2,
        ], [
            'en' => 'Roles',
            'zh_Hant' => '角色管理',
        ...
        $this->createMenu($portal, $acl->id, [
            'permission_name' => permName('system_acl.user.menu'),
            'route_name' => 'lang.ocadmin.system.acl.users.index',
            'sort_order' => 3,
        ], [
            'en' => 'Users',
            'zh_Hant' => '使用者管理',
        ...
        $this->createMenu($portal, $acl->id, [
            'permission_name' => permName('system_acl.access_token.menu'),
            'route_name' => 'lang.ocadmin.system.acl.access-tokens.index',
            'sort_order' => 4,
        ], [
            'en' => 'Access Token',
        ...
        $this->createMenu($portal, $acl->id, [
            'permission_name' => permName('system_acl.user_device.menu'),
            'route_name' => 'lang.ocadmin.system.acl.user-devices.index',
            'sort_order' => 5,
        ], [
            'en' => 'User Devices',
            'zh_Hant' => '裝置管理',
        ...
        $this->createMenu($portal, $system->id, [
            'permission_name' => permName('system.setting.menu'),
        ...
        $this->createMenu($portal, $vocab->id, [
            'permission_name' => permName('system.taxonomy.menu'),
            'route_name' => 'lang.ocadmin.system.taxonomies.index',
            'sort_order' => 1,
        ], [
            'en' => 'Taxonomies',
            'zh_Hant' => '分類管理',
        ...
        $this->createMenu($portal, $vocab->id, [
            'permission_name' => permName('system.term.menu'),
            'route_name' => 'lang.ocadmin.system.terms.index',
            'sort_order' => 2,
        ], [
            'en' => 'Terms',
            'zh_Hant' => '詞彙項目',
        ...
        // 系統管理 > 選單設定
        $this->createMenu($portal, $system->id, [
            'permission_name' => permName('system.menu.menu'),
        ...
        // 系統管理 > 資料表結構
        $this->createMenu($portal, $system->id, [
            'permission_name' => permName('system.schema.menu'),
        ...
        // 系統管理 > 遷移功能（權限不指派 role → 實質只有 super_admin 看得到）
        $this->createMenu($portal, $system->id, [
            'permission_name' => permName('system.transition.menu'),
            'route_name' => 'lang.ocadmin.system.transition.index',
            'sort_order' => 7,
        ], [
            'en' => 'Transitions',
            'zh_Hant' => '遷移功能',
        ...
        // 系統管理 > 日誌管理
        $this->createMenu($portal, $system->id, [
            'permission_name' => permName('system.log.menu'),
