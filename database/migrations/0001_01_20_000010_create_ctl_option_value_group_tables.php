...
return new class extends Migration
{
    ...
    {
        Schema::create('ctl_option_value_groups', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('ctl_option_value_group_translations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('option_value_group_id', 'ovg_trans_group_id_fk')
                  ->references('id')->on('ctl_option_value_groups')->cascadeOnUpdate()->cascadeOnDelete();
            $table->unique(['option_value_group_id', 'locale'], 'ovg_trans_group_locale_unique');
        });

        Schema::create('ctl_option_value_group_levels', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('option_value_group_id');
            ...
            $table->foreign('option_value_group_id', 'ovg_levels_group_id_fk')
                  ->references('id')->on('ctl_option_value_groups')->cascadeOnDelete();
            $table->foreign('option_id', 'ovg_levels_option_id_fk')
                  ->references('id')->on('ctl_options')->cascadeOnDelete();
        ...
        Schema::create('ctl_option_value_links', function (Blueprint $table) {
            ...
            $table->foreign('parent_option_value_id', 'ovl_parent_value_id_fk')
                  ->references('id')->on('ctl_option_values')->cascadeOnDelete();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('ctl_option_value_group_levels');
        Schema::dropIfExists('ctl_option_value_group_translations');
        Schema::dropIfExists('ctl_option_value_groups');
    }
};
